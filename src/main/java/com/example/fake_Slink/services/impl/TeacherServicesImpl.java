...
public class TeacherServicesImpl implements TeacherServices {
    ...
    public Boolean addTeachers(List<CreateTeacherRequest> list) throws Exception {
        ...
        for (var x : list) {
            ...
            Teacher newTeacher = Teacher.fromCreateTeacherRequest(x, newIdNum, encodePassword, department);
    ...
    @Override
    public TeacherResponse getTeacherDetail(IntrospectRequest introspectRequest) throws Exception {
        return null;
    }
}
